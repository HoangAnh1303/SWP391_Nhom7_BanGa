                ...
                <div class="main-panel">
                    <div class="content-wrapper">
                        <div class="page-header">
                            <h3 class="page-title" style="font-size: 30px"> Tất cả các sản phẩm </h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Tất cả gà</h4>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="template-demo">
                                                            ...
                                                            <button  type="button" class="btn btn-gradient-info btn-rounded btn-fw">Cập nhâp</button>
                                                        </div>
                            ...
                            <div class="col-lg-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Thức ăn cho gà</h4>
                             ...
                             <div class="col-lg-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Tất cả dụng cụ</h4>
