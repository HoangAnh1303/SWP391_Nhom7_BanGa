<%-- 
    Document   : Thongtinlienhe
    Created on : 09/08/2023, 3:51:33 AM
    Author     : hoang
--%>
...
<!--                            <div class="form-group col-md-6 mb-3">
                            ...
                            <div class="form-group col-md-12 mb-3">
                                <textarea required placeholder="Tin nhắn *" id="description" class="form-control" name="message" rows="4"></textarea>
                            </div>
