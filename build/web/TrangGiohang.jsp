<%-- 
    Document   : TrangGiohang
    Created on : 09/08/2023, 8:20:32 AM
    Author     : hoang
--%>
                	...
                	<table class="table">
                        ...
                        <tbody>
                        	<tr>
                                ...
                                <td class="product-name" data-title="Product"><a href="#">Gà chọi</a></td>
                                <td class="product-price" data-title="Price">$45.00</td>
                              	<td class="product-stock-status" data-title="Stock Status">1<span class="badge badge-pill badge-success"></span></td>
                                <td class="product-add-to-cart"><a href="#" class="btn btn-fill-out"><i class="icon-basket-loaded"></i>Thanh toán</a></td>
